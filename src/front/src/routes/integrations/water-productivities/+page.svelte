...
<main class="page">
	<header class="header">
		<h1>Integraciones de Mario Ramírez García</h1>
		<p>
			Esta entrada sirve como acceso dentro de <code>/integrations</code> al trabajo asociado al
			recurso <code>water-productivities</code>.
		</p>
